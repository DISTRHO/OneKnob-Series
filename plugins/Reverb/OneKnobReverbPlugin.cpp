...
#include "OneKnobReverbPlugin.hpp"
...
OneKnobReverbPlugin::OneKnobFilterPlugin()
...
void OneKnobReverbPlugin::initParameter(uint32_t index, Parameter& parameter)
{
    switch (index)
    {
...
void OneKnobReverbPlugin::initProgramName(uint32_t index, String& programName)
{
    switch (index)
    {
...
void OneKnobReverbPlugin::initState(uint32_t index, String& stateKey, String& defaultStateValue)
{
...
float OneKnobReverbPlugin::getParameterValue(uint32_t index) const
{
    return parameters[index];
}

void OneKnobReverbPlugin::setParameterValue(const uint32_t index, const float value)
{
    switch (index)
    {
    case kParameterKneePoint:
...
void OneKnobReverbPlugin::loadProgram(uint32_t index)
{
    switch (index)
    {
    case kProgramDefault:
...
void OneKnobReverbPlugin::setState(const char*, const char*)
{
...
void OneKnobReverbPlugin::activate()
{
...
void OneKnobReverbPlugin::run(const float** const inputs, float** const outputs, const uint32_t frames)
{
...
Plugin* createPlugin()
{
    return new OneKnobReverbPlugin();
}
