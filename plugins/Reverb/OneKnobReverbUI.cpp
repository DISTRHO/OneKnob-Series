...
OneKnobReverbUI::OneKnobFilterUI()
...
void OneKnobReverbUI::parameterChanged(const uint32_t index, const float value)
{
    switch (index)
    {
...
void OneKnobReverbUI::programLoaded(const uint32_t index)
{
    switch (index)
    {
...
void OneKnobReverbUI::stateChanged(const char*, const char*)
{
}
