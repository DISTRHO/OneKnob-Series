...
#include "OneKnobFilterPlugin.hpp"
...
OneKnobFilterPlugin::OneKnobFilterPlugin()
...
void OneKnobFilterPlugin::initParameter(uint32_t index, Parameter& parameter)
{
    switch (index)
    {
...
void OneKnobFilterPlugin::initProgramName(uint32_t index, String& programName)
{
    switch (index)
    {
...
void OneKnobFilterPlugin::initState(uint32_t index, String& stateKey, String& defaultStateValue)
{
...
float OneKnobFilterPlugin::getParameterValue(uint32_t index) const
{
    return parameters[index];
}

void OneKnobFilterPlugin::setParameterValue(const uint32_t index, const float value)
{
    switch (index)
    {
    case kParameterKneePoint:
...
void OneKnobFilterPlugin::loadProgram(uint32_t index)
{
    switch (index)
    {
    case kProgramDefault:
...
void OneKnobFilterPlugin::setState(const char*, const char*)
{
...
void OneKnobFilterPlugin::activate()
{
...
void OneKnobFilterPlugin::run(const float** const inputs, float** const outputs, const uint32_t frames)
{
